const ConnectionCard = ({ user, type, onAccept, onIgnore, isConnection, onMessage }) => {
    return (
            ...
            <div className="w-full pt-2">
                <div className="w-full pt-2">
                    {isConnection ? (
                        ...
                        <button className="text-blue-600 font-medium px-4 py-1 rounded-full border border-blue-600 hover:bg-blue-50 w-full">
                            Connect
                        </button>
                    )}
                </div>
